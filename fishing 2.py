...
def get_font(size):  # Returns Press-Start-2P in the desired size
    return pygame.font.Font("assets/Sobread.ttf", size)
...
def main_menu():
    while True:
        ...
        MENU_TEXT = get_font(100).render("Life Under the Sea", True, "White")
        MENU_RECT = MENU_TEXT.get_rect(center=(640, 100))

        PLAY_BUTTON = Button(image=pygame.image.load("assets/Play Rect.png"), pos=(640, 320),
